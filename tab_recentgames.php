...
?>
	...
	<?php
$recentResult = $database->query(" SELECT g.*, p.name, p.icon, p.alias AS PlatformAlias FROM games AS g, platforms AS p WHERE g.Platform = p.id ORDER BY lastupdated DESC LIMIT 50 ");
$count = 1;
