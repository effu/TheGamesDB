...
function processFanart($platformID)
{
    ...
    $faResult = $database->query(" SELECT filename FROM banners WHERE keyvalue = $platformID AND keytype = 'platform-fanart' ORDER BY filename ASC ");
...
function processBoxart($platformID)
{
    ...
    $baResult = $database->query(" SELECT filename FROM banners WHERE keyvalue = $platformID AND keytype = 'platform-boxart' ORDER BY filename ASC ");
...
{
    ## Select all boxart rows for the requested game id
    $banResult = $database->query(" SELECT filename FROM banners WHERE keyvalue = $platformID AND keytype = 'platform-banner' ORDER BY filename ASC ");
