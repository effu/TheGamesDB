...
?>
	...
	<?php
$recentResult = $database->query(" SELECT p.*, AVG(r.rating) toprating FROM platforms AS p, ratings AS r WHERE r.itemid = p.id AND r.itemtype = 'platform' GROUP BY p.id ORDER BY toprating DESC LIMIT 10; ");
$count = 1;
